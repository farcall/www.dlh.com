...
<div id="rightTop">
    <p>供求信息</p>
    <ul class="subnav">
        <li><a class="btn1" href="index.php?app=supply_demand">信息管理</a></li>
        <li><a class="btn1" href="index.php?app=supply_demand&amp;act=wait_verify">待审核</a></li>
        <li><span>分类管理</span></li>
        <li><a class="btn1" href="index.php?app=supply_demand&amp;act=add_cate">新增分类</a></li>
    </ul>
</div>
<div class="info2">
...
?>
            <tr>
                ...
                <td class="align_center"><?php if (! $this->_var['acategory']['code']): ?>
                    <span ectype="inline_edit" fieldname="sort_order_cate" fieldid="<?php echo $this->_var['acategory']['cate_id']; ?>" datatype="pint" maxvalue="255" class="editable"><?php echo $this->_var['acategory']['sort_order']; ?></span>
                    <?php endif; ?></td>
                <td class="handler"><span>
                    <a href="index.php?app=supply_demand&amp;act=edit_cate&amp;id=<?php echo $this->_var['acategory']['cate_id']; ?>">编辑</a> | <a href="javascript:if(confirm('删除该分类将会同时删除该分类的所有下级分类，您确定要删除吗'))window.location = 'index.php?app=supply_demand&amp;act=drop_cate&amp;id=<?php echo $this->_var['acategory']['cate_id']; ?>';">删除</a>
                    <?php if ($this->_var['acategory']['layer'] < $this->_var['max_layer']): ?>
                    | <a href="index.php?app=supply_demand&amp;act=add_cate&amp;pid=<?php echo $this->_var['acategory']['cate_id']; ?>">新增下级</a>
                    <?php endif; ?>
                    </span> </td>
            </tr>
            <?php endforeach; else: ?>
        ...
        <tfoot>
            <tr class="tr_pt10">
                ...
                <td colspan="3" id="batchAction"><span class="all_checkbox">
                    ...
                    <input class="formbtn batchButton" type="button" value="删除" name="id" uri="index.php?app=supply_demand&act=drop_cate" presubmit="confirm('删除该分类将会同时删除该分类的所有下级分类，您确定要删除吗');" />
                </td>
                <?php endif; ?>
            </tr>
        </tfoot>
