...
?>
        <tr class="tatr2">
            ...
            <td><?php echo htmlspecialchars($this->_var['integral_goods_log']['my_name']); ?></td>
            <td><?php echo htmlspecialchars($this->_var['integral_goods_log']['my_address']); ?></td>
            <td><?php echo htmlspecialchars($this->_var['integral_goods_log']['my_mobile']); ?></td>
            <td><?php echo htmlspecialchars($this->_var['integral_goods_log']['my_num']); ?></td>
            <td><?php echo $this->_var['integral_goods_log']['wuliu_name']; ?><br/><?php echo $this->_var['integral_goods_log']['wuliu_danhao']; ?></td>
            <td><?php echo htmlspecialchars($this->_var['integral_goods_log']['state']); ?></td>
            <td><?php echo local_date("Y-m-d",$this->_var['integral_goods_log']['add_time']); ?></td>
            <td class="handler">
