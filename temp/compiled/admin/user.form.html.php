  ...
  <form method="post" enctype="multipart/form-data" id="user_form">
    <table class="infoTable">
      ...
      <tr>
        ...
        <td class="paddingT15 wordSpacing5"><span><?php echo htmlspecialchars($this->_var['user']['grade_name']); ?></span>
        	<input type="hidden" value="<?php echo $this->_var['user']['ugrade']; ?>" name="grade_id" class="ugrade"/>
            <input type="button" value="编辑" class="edit_grade" />
            <select style="display:none" name="grade_id" id="grade_id">
              <option value=''>请选择...</option>
              <?php echo $this->html_options(array('options'=>$this->_var['ugrades'],'selected'=>$this->_var['user']['ugrade'])); ?>
            </select></td>
      </tr>
      <tr>
        <th class="paddingT15"> 成长值:</th>
        <td class="paddingT15 wordSpacing5"> <?php echo $this->_var['user']['growth']; ?></td>
      </tr>
            <?php if ($_GET['act'] == 'edit'): ?>
            <tr>
                <th class="paddingT15">当前可用白积分:</th>
                <td class="paddingT15 wordSpacing5"><?php echo $this->_var['user']['integral']; ?></td>
            </tr>
            <tr>
                <th class="paddingT15">当前总白积分:</th>
                <td class="paddingT15 wordSpacing5"><?php echo $this->_var['user']['total_integral']; ?></td>
            </tr>
            <tr>
                <th class="paddingT15">白积分操作:</th>
