        ...
        ComplexCustomOverlay.prototype.initialize = function(map) {
            ...
            if (data.done) {
                if (data.retval.store_num > 0) {
                    div.innerHTML = "<span style='font-size:10pt;color:#FF6000;margin:5px 0;display:inline-block'>" + data.retval.region_addr + "</span><br /><span style='font-size:13pt;color:#999;margin:10px 0;display:inline-block'>周边10千米共有 <b style='color:#FF6000' >" + data.retval.store_num + " </b>家餐厅</span>";
