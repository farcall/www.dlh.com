...
?>
        ...
        <div id="nav">
            <ul>
                ...
                <a href="<?php echo url('app=store&id=' . $this->_var['store']['store_id']. '&act=search'); ?>"><li  class="<?php if ($_GET['app'] == 'store' && $_GET['act'] == 'index'): ?>active<?php else: ?>normal<?php endif; ?>" >所有商品</li></a>
                <a href="javascript:void(0)" onclick="showShare('sharebox');"><li  class="normal" >分享商城</li></a>
            </ul>
        </div>
