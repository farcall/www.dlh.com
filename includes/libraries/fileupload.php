...
define('APP_PATH', str_replace('\\', '/', str_replace('\\', '/', realpath(dirname(__FILE__) . '/../../'))) . "/");
...
$targetDir = APP_PATH . 'data/image/offline/upload_tmp/';
$uploadDir = APP_PATH . 'data/image/offline/upload/';
...
$file_info = get_uploaded_info($_FILES["file"]);
$uploadPath = $uploadDir . DIRECTORY_SEPARATOR . random_filename();
...
function get_uploaded_info($file)
{
